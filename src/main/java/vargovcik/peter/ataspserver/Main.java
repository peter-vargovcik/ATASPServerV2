package vargovcik.peter.ataspserver;
...
import vargovcik.peter.ataspserver.server.CompanionAppServer;
import vargovcik.peter.ataspserver.server.SearchMode;
import vargovcik.peter.ataspserver.sensors.Bmp180;
import vargovcik.peter.ataspserver.controller.*;
import vargovcik.peter.ataspserver.interfaces.*;
...
public class Main {
    ...
    private SensorsController sensors;
	...
	private void initAll() {
        ...
        peripheralsController = PeripheralsController.getInstance();
        peripheralsController.addProximityListenner(proximityInterface);
        peripheralsController.startFetching();
        
        proximityController = ProximityController.getInstance();
        proximityController.addProximityListenner(proximityInterface);
        proximityController.startFetching();
        
        sensors = SensorsController.getInstance();
        sensors.addSensorListenner(sensorsInterface);
