package vargovcik.peter.ataspserver.sensors;
...
public class AdafruitBMP180 {
    ...
    private static class SingletonHelper{
        private static final AdafruitBMP180 INSTANCE = new AdafruitBMP180();
    }
    
    public static AdafruitBMP180 getInstance(){
        return SingletonHelper.INSTANCE;
    }	
	
    private AdafruitBMP180(){
	    this(BMP180_ADDRESS);
    }
	  
    private AdafruitBMP180(int address){
	    try
	    {
	      // Get i2c bus
